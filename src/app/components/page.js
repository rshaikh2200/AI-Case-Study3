 ...
 return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="AI Personalized Healthcare Safety Training Module"
        />
      </Head>
            ...
            {showSafetyStatement && (
              <div className="mb-8 bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-600">
                <p className="text-gray-700 leading-relaxed">
                  <span className="font-semibold text-blue-700 block mb-2 text-lg">
                    Why This Matters:
                  </span>
                  Avoidable medical error is a leading cause of death in the USA.
                  Something as simple as using safety behaviors has been proven to
                  decrease harm to patients. The scenarios generated below are from real
                  case studies that have been published in the literature and are
                  customized just for you in order to make the safety behavior more
                  relevant.
                  <span className="mt-2 block font-medium text-blue-600">
                    Thank you for doing your part to put more care into healthcare.
                  </span>
                </p>
              </div>
            )}
                        ...
                        <div
                          ...
                          style={{
                            clipPath: `polygon(50% 50%, 50% 0%, ${
                              ...
                              50 *
                                Math.sin(
                                  ((totalScore / 100) * 360 * Math.PI) / 180
                                )
                            }% ${
                              50 -
                              50 *
                    ...
                    <div className="flex-grow">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {resultDetails.slice(0, 2).map((caseDetail) => (
                          <div
                            key={`summary-${caseDetail.caseStudyNumber}`}
                            className="bg-gray-50 rounded-lg p-4"
                          >
                            <h4 className="font-medium text-blue-700 mb-2">
                              {`Case Study ${caseDetail.caseStudyNumber}`}
                            </h4>
                            <div className="flex items-center gap-2 mb-2">
                              <div className="w-8 h-8 rounded-full bg-blue-100 flex items-center justify-center">
                                {
                                  caseDetail.questions.filter((q) => q.isCorrect)
                                    .length
                                }
                                /{caseDetail.questions.length}
                              </div>
                        ...
                        <div className="flex items-center gap-4">
                          <div
                            className={`w-10 h-10 rounded-full flex items-center justify-center font-bold text-white ${
                              caseDetail.questions.filter((q) => q.isCorrect).length ===
                              caseDetail.questions.length
                                ? 'bg-green-600'
                                : 'bg-blue-600'
                            }`}
                  ...
                  caseStudies[currentCaseStudyIndex].questions.length > 0 ? (
                    <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
                      <h4 className="text-lg font-semibold text-gray-800 mb-4">
                        {`Question ${currentQuestionIndex + 1}: ${
                          caseStudies[currentCaseStudyIndex].questions[currentQuestionIndex]
                            .question
                        }`}
                      </h4>
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
                      ...
                      <p className="mt-1 text-sm text-gray-500">
                        No questions are available for this case study.
                      </p>
                    </div>
                  )}
                </div>
            ...
            {showCaseStudies && Array.isArray(caseStudies) && caseStudies.length === 0 && (
              <div className="bg-white rounded-xl shadow-md p-8 text-center">
                ...
                <p className="mt-1 text-gray-500">
                  No case studies are available at the moment. Please try again later.
                </p>
                <div className="mt-6">
                  <button
                    type="button"
