...
export async function POST(request) {
  ...
  if (userType === 'clinical') {
    META_PROMPT = `Please generate 4 medical case studies, each  200 - 250 words, featuring a scenario for a ${role} in the ${department} department specializing in ${specialization}. Use the following ${retrievedCasesText} as examples of real world medical case studies scenarios to help generate detailed and descriptive medical case studies. Each case study should:
    ...
    - **Case Study Content:**
      ...
      - Make sure the error prevention tool name is not mentioned in the scenario itself, or its definition. 
    ...
    **Example:**
    ...
    META_PROMPT = `Please generate 4 medical case studies, each 200 - 250 words, featuring a scenario for a ${role} in the ${department} department specializing in ${specialization}. Use the following ${retrievedCasesText} to help generate detailed and descriptive medical case studies. Each case study should:
