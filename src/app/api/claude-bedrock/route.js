        ...
        knowledgeBaseConfiguration: {
          ...
          generationConfiguration: {
            promptTemplate: {
              ...
              textPromptTemplate: "You are a helpful AI assistant for Job Hunt Tech. This is data you're given about Job Hunt Tech: $search_results$. Be concise and keep the message close to 350 words."
            },
            inferenceConfig: {
              textInferenceConfig: {
                temperature: 0.7,
